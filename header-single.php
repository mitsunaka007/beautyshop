...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		<div class="site-logo">
			<a href="<?php home_url(); ?>"><img src="http://mityu-ka.sakura.ne.jp/beautyshop/wp-content/uploads/2023/01/Beauty-Shop.png" alt="beautyShop"></a>
		</div>
		<div class="bookmark">
			<p><a href="#" rel="sidebar" id="add-site"><i class="fa-regular fa-bookmark bookmark-size"  style="color: #FF8298;"></i></a></p>
		</div>
